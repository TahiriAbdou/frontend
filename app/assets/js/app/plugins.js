...
var AUROUS_PLUGINS = [
    ["hello", 1, "Andrews Hello Script", "Andrew", "This plugin should list all plugins currently found on the system.", "https://github.com/Codeusa/", "https://twitter.com/andrewmd5", false],
...
window.as = $; //lets bind jquery to a less shitty character
window.aurousScript = $; //lets bind jquery to a less shitty character
        ...
        "activePlugins": {
            ...
            'callback': function() {
                ...
                for (var pluginName in activePlugins) {
                    ...
                    //if plugin lacks a .init it will not be loaded
                    try {
